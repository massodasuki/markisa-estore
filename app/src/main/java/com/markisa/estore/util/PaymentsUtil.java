package com.markisa.estore.util;
...
import com.markisa.estore.Constants;
...
//        googleMID = '10632845976650230763';
    ...
    private static JSONObject getDirectTokenizationSpecification()
        ...
        Log.e("tokenizationSpecification failed", String.valueOf(tokenizationSpecification));
...
//        cardPaymentMethod.put("tokenizationSpecification", getDirectTokenizationSpecification());
        Log.i("cardPaymentMethod failed", String.valueOf(cardPaymentMethod));
        return cardPaymentMethod;
    }
    ...
    private static JSONObject getMerchantInfo() throws JSONException {
        ...
        // Change below follow your merchantId at Google Business Profile
        merchantInfo.put("merchantId", "BCR2DN6TXXXXXXXX");
        merchantInfo.put("merchantName", "Markisa Studios");
